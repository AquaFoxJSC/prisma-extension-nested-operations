...
export declare function withNestedOperations<ExtArgs extends Types.Extensions.InternalArgs = Types.Extensions.DefaultArgs>({ $rootOperation, $allNestedOperations, }: {
